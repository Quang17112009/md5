...
# CẤU HÌNH HỆ THỐNG
# ==============================================
TOKEN = os.getenv("7870427050:AAGIgGcqq7zkcTirUDw9ZIF8Li_blWHPmfA")
if not TOKEN:
    raise ValueError("❌ BOT_TOKEN chưa được thiết lập.")
ADMIN_ID = 6915752059
LIEN_HE_HO_TRO = "@nhutquangdz"
NHOM_YEU_CAU = ["@toolviphahaa", "@techtitansteamchat"]
MA_VIP = "VIP7NGAYMIENPHI"
TEN_BOT = "botmd5freev2_bot"
