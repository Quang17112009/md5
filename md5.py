...
TOKEN = os.getenv("BOT_TOKEN") or "7870427050:AAGIgGcqq7zkcTirUDw9ZIF8Li_blWHPmfA"
ADMIN_ID = 6915752059  # Thay bằng ID admin của bạn
SUPPORT_CONTACT = "@nhutquangdz"
REQUIRED_GROUPS = ["@toolviphahaa"]  # Các nhóm yêu cầu
PREMIUM_CODE = "PREMIUM7DAY"
BOT_USERNAME = "botmd5freev2_bot"
BANK_ACCOUNT = {
    "name": "NGUYEN HUYNH NHUT QUANG",
    "number": "0939766383",
    "bank": "MB BANK"
}
ADMIN_SECRET_KEY = "nhutquangdz"  # Key bí mật cho xác thực admin
